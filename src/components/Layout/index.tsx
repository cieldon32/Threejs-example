          ...
          <div className="h-full overflow-y-auto scrolling-touch lg:h-auto lg:block lg:relative lg:sticky lg:top-16 bg-white lg:bg-transparent">
            <nav className="px-6 pt-8 overflow-y-auto text-base lg:text-sm lg:py-12 lg:pl-6 lg:pr-8 sticky?lg:h-(screen-16)">
              <div className="mb-10 mt-10">
                ...
                <Link to="/house" className="flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium text-gray-600">House</Link>
                <Link to="/stage" className="flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium text-gray-600">Stage</Link>
              </div>
            </nav>
          </div>
        </div>
